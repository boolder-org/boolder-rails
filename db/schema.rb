...
ActiveRecord::Schema[8.0].define(version: 2025_05_12_150629) do
  ...
  create_table "problems", force: :cascade do |t|
    ...
    t.index ["end_id"], name: "index_problems_on_end_id"
    ...
    t.index ["start_id"], name: "index_problems_on_start_id"
  end
