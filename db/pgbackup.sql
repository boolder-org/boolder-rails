...
SELECT pg_catalog.setval('public.boulders_id_seq', 528, true);
...
SELECT pg_catalog.setval('public.lines_id_seq', 652, true);
...
SELECT pg_catalog.setval('public.problems_id_seq', 676, true);
