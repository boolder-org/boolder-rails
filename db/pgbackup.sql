...
SELECT pg_catalog.setval('public.boulders_id_seq', 504, true);
...
SELECT pg_catalog.setval('public.lines_id_seq', 604, true);
...
SELECT pg_catalog.setval('public.problems_id_seq', 606, true);
