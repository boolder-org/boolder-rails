...
SELECT pg_catalog.setval('public.boulders_id_seq', 505, true);
...
SELECT pg_catalog.setval('public.lines_id_seq', 607, true);
...
SELECT pg_catalog.setval('public.problems_id_seq', 609, true);
