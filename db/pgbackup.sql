...
SELECT pg_catalog.setval('public.boulders_id_seq', 509, true);
...
SELECT pg_catalog.setval('public.lines_id_seq', 624, true);
...
SELECT pg_catalog.setval('public.problems_id_seq', 627, true);
