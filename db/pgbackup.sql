...
SELECT pg_catalog.setval('public.boulders_id_seq', 507, true);
...
SELECT pg_catalog.setval('public.lines_id_seq', 613, true);
...
SELECT pg_catalog.setval('public.problems_id_seq', 616, true);
